...
public class BoggleStats {
    ...
    private static BoggleBoard boardStore ; 
    ...
    public String wordTester(IAutoPlayer player, ILexicon lex, ArrayList<Integer> log, int count){
       ...
       System.out.println(myMaxBoard.toString());
...
//        bs.runTests(lex,list);
//        System.out.println();
        System.out.println(boardStore.toString()); 
